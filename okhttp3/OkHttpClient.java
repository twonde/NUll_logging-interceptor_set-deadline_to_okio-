...
public class OkHttpClient implements Cloneable, Call.Factory {
  ...
  final int  processTimeout; //tony wonde comp490
  ...
  /* set a timeout to the whole request process *//* comp490 */
  public int processTimeOutMillis(){
   return processTimeout;//tony wonde comp490
  }
  ...
  public static final class Builder {
    ...
    int connectTimeout;
    int readTimeout;
    int processTimeout; //tony wonde comp490
    int writeTimeout;
    ...
    public Builder() {
      ...
      readTimeout = 10_000;
      writeTimeout = 10_000;
      processTimeout = 10_00; //tony wonde comp490
    }
    ...
    Builder(OkHttpClient okHttpClient) {
      ...
      this.processTimeout = okHttpClient.processTimeout; //tony wonde comp490
    }
    ...
    /*  set time for whole processs**/
        public Builder processTimeout(long timeout, TimeUnit unit) {
      if (timeout < 0) throw new IllegalArgumentException("timeout < 0");
      if (unit == null) throw new NullPointerException("unit == null");
      long millis = unit.toMillis(timeout);
      if (millis > Integer.MAX_VALUE) throw new IllegalArgumentException("Timeout too large.");
